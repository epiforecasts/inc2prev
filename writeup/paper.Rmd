...
params[name == "gamma", name := ifelse(p_index == 1, "gamma (infection)", "gamma (vaccination)")]
...
knitr::include_graphics(here::here("figures", "readme", "example-estimates.png"))
```
...
Posterior estimates of recovered biological parameters are shown in Table \@ref{tab:prams-table}.
...
knitr::include_graphics(here::here("figures", "readme", "pairs.png"))
```
