...
params[, Description := fcase(
           ...
           name == "gamma (infection)", "Antibody waning following infection",
           name == "gamma (vaccination)", "Antibody waning following vaccination",
...
biol_params[, `Estimate (90% CI)` := paste0(signif(q5, 2), "--", signif(q95, 2))]
